...
const Image = (props:UInputImgProps) => {
  ...
  <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
   ...
   {isUploaded ? <button disabled className='text-green-500 ml-6 mt-4 bg-white text-white px-4 py-2 rounded-md text-sm font-medium'>saved</button>
   :<button onClick={uploadHandler} className="ml-6 mt-4 bg-gray-800 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800">save</button>
}
    </div>
  </div>
</div>
