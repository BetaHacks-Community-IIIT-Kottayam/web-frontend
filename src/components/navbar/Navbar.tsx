      ...
      <nav className="bg-gray-700 px-4">
        <div className="mx-auto py-4 flex justify-between items-center">
          <Link to="/">
            <h1 className="text-2xl font-bold text-gray-50">
              <img
                src={logoImage}
                alt="Logo"
                className="h-8 w-8 mr-2 inline rounded-full"
              />
              Betahacks
            </h1>
          </Link>
          <div className="hidden sm:flex md:flex lg:flex items-center space-x-12">
            ...
            <Link to="/about-community">
              <div className="flex items-center space-x-2 cursor-pointer">
                ...
                <span
                  className={`text-gray-50 ${
                    location.pathname === "/about-community"
                      ? "underline underline-offset-8"
                      : ""
                  }`}
                >
          ...
          {!isAuth ? (
            ...
            <Menu
              as="div"
              className="w-16 relative ml-3 hidden sm:flex md:flex lg:flex items-center space-x-8"
            >
              <div>
                <Menu.Button className="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                  ...
                  <img
                    ...
                    src={
                      userInfo.imgUrl
                        ? userInfo.imgUrl
                        : "https://previews.123rf.com/images/triken/triken1608/triken160800028/61320729-male-avatar-profile-picture-default-user-avatar-guest-avatar-simply-human-head-vector-illustration.jpg"
                    }
                    alt=""
                  />
                </Menu.Button>
              ...
              >
                <Menu.Items className="absolute right-0 top-2 z-10 mt-8 w-48 rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                  <Menu.Item>
                    {({ active }) => (
                      <Link
                        to="/v1/user/profile"
          ...
          <div className="flex sm:hidden md:hidden lg:hidden items-center">
            <SideNavbar
              ...
              setLastLocationHandler={setLastLocationHandler}
              logoutHandler={() => {
                setPop(true);
              }}
            />
