                                        ...
                                        <div className="flex items-center justify-between sm:mt-2">
                                            <div className="flex items-center">
                                                <div className="flex flex-col">
                                                    <div className="w-full flex-none text-lg text-gray-200 font-bold leading-none">Aditya Shinde</div>
                                                    ...
                                                    <div className="flex-auto text-gray-400 my-1">
                                                        <span className="mr-3">s.adityashinde11@gmail.com</span><span className="mr-3 border-gray-600 max-h-0"></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className="grid grid-cols-12 gap-4 ">
                            ...
                            <div className="col-span-12 sm:col-span-4">
                                <div className="p-4 relative bg-gray-800 border border-gray-800 shadow-lg rounded-2xl">
                                    ...
                                    <div className="text-2xl text-gray-100 font-medium leading-8 mt-5">05</div>
